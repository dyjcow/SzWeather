...
public class SunView extends View {
    ...
    private void initView(Context context, @Nullable AttributeSet attrs) {
        ...
        mCircleColor = type.getColor(R.styleable.SunView_sun_circle_color, MyUtil.ViewGetColor(mContext,R.color.sun_line_color));
        mFontColor = type.getColor(R.styleable.SunView_sun_font_color, MyUtil.ViewGetColor(mContext,R.color.colorAccent));
        ...
        mTimePaint.setColor(MyUtil.ViewGetColor(mContext,R.color.air_text_common_light));
        ...
        mLinePaint.setColor( MyUtil.ViewGetColor(mContext,R.color.color_999));

        // 渐变遮罩的画笔
        shadePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        shadePaint.setColor(MyUtil.ViewGetColor(mContext,R.color.attention_text_light));
        shadePaint.setStyle(Paint.Style.FILL);

        mPathPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPathPaint.setColor( MyUtil.ViewGetColor(mContext,R.color.attention_text_light));
...
//        mCirclePaint.setColor(mContext.getResources().getColor(R.color.color_999));
        ...
        if (isSun) {
            mSunIcon = MyUtil.compressBySize(getContext(), R.drawable.icon_sun, iconSize, iconSize);
        } else {
            mSunIcon = MyUtil.compressBySize(getContext(), R.drawable.icon_moon, iconSize, iconSize);
        }
