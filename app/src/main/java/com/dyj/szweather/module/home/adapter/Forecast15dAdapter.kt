...
class Forecast15dAdapter(val context: Context, val datas: List<WeatherDay>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            ivDay.setImageResource(MyUtil.getWeatherIcon(context,item.iconDay))

            ivNight.setImageResource(MyUtil.getWeatherIcon(context,item.iconNight))
